...
class TuningParameters():
    #data params
    _train_ways=5                  #Support:Classes
    _train_samples=10                #Support:No.of examples in each class
    _test_samples=15                #Query:Samples
    
    #meta params
    _inner_loop=6                   #how many times the collective losses are summed and updated
    _outer_loop=1000                   #how many distinct losses are calculated  
