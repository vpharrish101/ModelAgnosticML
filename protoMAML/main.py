...
from learner import ResNet18_mod,protoMAML_lossfn
import test
...
def main():
    ...
    learner=l2l.algorithms.MAML(model,lr=0.005,first_order=True)
    optimizer=optim.Adam(learner.parameters(),lr=0.002)
    ...
    for x in range(p.outer_loop):
        ...
        for y in range(p.inner_loop):
            ...
            query_loss,query_acc=protoMAML_lossfn(support_data,support_labels,query_data,query_labels,learner_clone,lossFn,p.adp_steps)
